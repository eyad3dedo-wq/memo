...
/* English and Arabic content switch */
var arabicTranslations = {
    'Home': 'الرئيسية', 'About': 'عن المطعم', 'Menu': 'القائمة', 'Chefs': 'الشيفات',
    'Reservation': 'الحجز', 'Reviews': 'آراء العملاء', 'Contact': 'تواصل معنا',
    'Order Now': 'اطلب الآن', 'What We Offer': 'ماذا نقدم', 'Browse by ': 'تصفح حسب ',
    'Category': 'التصنيف', 'All Items': 'كل الأصناف', 'Burgers': 'برجر', 'Pizza': 'بيتزا',
    'Fried Chicken': 'فراخ مقلية', 'Wraps': 'راب', 'Desserts': 'حلويات', 'Pasta': 'مكرونة',
    'Our Story': 'قصتنا', 'We Invite You to Visit': 'ندعوك لزيارتنا', 'Our ': 'مطعمنا ',
    'Food Restaurant': 'للمأكولات', '100% Fresh Ingredients': 'مكونات طازجة 100%',
    'Award-Winning Recipes': 'وصفات حاصلة على جوائز', 'Lightning-Fast Delivery': 'توصيل سريع',
    'View Full Menu': 'شاهد القائمة كاملة', "What's Cooking": 'ماذا نطبخ اليوم',
    'Our Delicious ': 'قائمتنا الشهية ', 'Limited Time Offer': 'عرض لفترة محدودة',
    'Get 30% Off': 'خصم 30%', 'Our Signature': 'وجبتنا المميزة', 'Burger': 'برجر',
    'Meal': 'وجبة', 'Grab the Deal': 'احصل على العرض', 'Food Showcase': 'معرض الأطباق',
    "Let's See Our ": 'شاهد ', 'Fast Food': 'أكلاتنا السريعة', 'Our Journey': 'رحلتنا',
    'A History of ': 'تاريخ ', 'Restaurant': 'المطعم', 'The Culinary Team': 'فريق المطبخ',
    'Meet Our Expert ': 'تعرف على ', 'Chefs': 'شيفاتنا', 'Head Chef': 'رئيس الشيفات',
    'Grill Master': 'خبير المشويات', 'Pastry Chef': 'شيف الحلويات', 'Pizza Artisan': 'خبير البيتزا',
    'Opening Hours': 'مواعيد العمل', "We're Open ": 'نحن مفتوحون ', 'For You': 'لاستقبالكم',
    'Order Online': 'اطلب أونلاين', 'Find Us': 'اعثر علينا', 'Address': 'العنوان',
    'Phone': 'الهاتف', 'Email': 'البريد الإلكتروني', 'What People Say': 'ماذا يقول عملاؤنا',
    'Our Customers ': 'آراء ', 'Feedback': 'عملائنا', 'Book a Table': 'احجز طاولة',
    'Make a ': 'قم بعمل ', 'Contact Info': 'بيانات التواصل', 'Location': 'الموقع',
    'Get In Touch': 'تواصل معنا', 'Contact ': 'تواصل ', 'Us': 'معنا', 'Quick Links': 'روابط سريعة',
    'Our Menu': 'قائمتنا', 'Designed by ': 'تصميم ', 'E11 Studio': 'E11 Studio',
    'Regular Customer': 'عميلة دائمة', 'Food Blogger': 'مدون طعام',
    'Food Enthusiast': 'محب للطعام', 'Corporate Client': 'عميل شركات'
};
...
function switchLanguage(language) {
    ...
    document.querySelectorAll('[data-lang-original]').forEach(function(node) {
        var original = node.getAttribute('data-lang-original');
        node.textContent = isArabic && arabicTranslations[original] ? arabicTranslations[original] : original;
    });
    document.querySelectorAll('input[placeholder], textarea[placeholder]').forEach(function(input) {
        if (!input.hasAttribute('data-lang-placeholder')) {
            input.setAttribute('data-lang-placeholder', input.getAttribute('placeholder'));
        }
        var original = input.getAttribute('data-lang-placeholder');
        input.setAttribute('placeholder', isArabic && arabicTranslations[original] ? arabicTranslations[original] : original);
    });
...
document.querySelectorAll('body *').forEach(function(element) {
    if (element.children.length === 0 && element.textContent.trim()) {
        ...
        if (arabicTranslations[text]) element.setAttribute('data-lang-original', text);
    }
});
...
if (localStorage.getItem('memo-language') === 'ar') switchLanguage('ar');
